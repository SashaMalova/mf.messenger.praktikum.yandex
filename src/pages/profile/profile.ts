...
export function profileTemplate(link: string, profile: {[key:string]:string}, arrBlack:{[key:string]:string}[], arrYellow: {[key:string]:string}[]) {
...
if (body) {
    body.innerHTML = profileTemplate(
        '../chat/select-chat.html',
        profile,
        [{
            nameField: 'Почта',
