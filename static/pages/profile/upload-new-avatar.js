...
if (h3) {
    h3.insertAdjacentHTML('beforebegin', '<a href="upload-new-avatar.html" class="change-avatar">' +
...
function formChangeAvatar(text) {
...
if (body) {
    body.insertAdjacentHTML('beforeend', formChangeAvatar('Загрузите файл'));
...
//# sourceMappingURL=upload-new-avatar.js.map